...
try:
    ...
    class Pandas_Failed_To_Import:
        pass
    pd = Pandas_Failed_To_Import

import time
# pylint: enable=missing-docstring, no-init, old-style-class,
# multiple-statements
...
class LiveBokehChart(object):
    ...
    def __init__(self, pandas_logger, metric_name, display_freq=10,
        ...
        # NOTE: would be nice to auto-detect the metric_name if there's only
        # one.
...
class LiveTimeSeries(LiveBokehChart):
    ...
    def __init__(self, **fig_params):
        ...
        # TODO: clean up this class hierarchy
...
class LiveLearningCurve(LiveBokehChart):
    ...
    def __init__(self, metric_name, display_freq=10, frequent=50):
        ...
        super(LiveLearningCurve, self).__init__(
            None, metric_name, display_freq, frequent)
